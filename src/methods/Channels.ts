...
class ChannelMethods {
     ...
     */
    async getChannel(channelId: string): Promise<TChannel> {
     ...
     */
    async updateChannel(channelId: string, data: {name?: string, position?: number, topic?: string, nsfw?: boolean, bitrate?: number, user_limit?: number, permission_overwrites?: TPermissionOverwrite[], parent_id?: string}) :Promise<TChannel> {
     ...
     */
    async deleteChannel(channelId: string): Promise<TChannel> {
     ...
     */
    async createMessage(channelId :string, data: PartialInputMessage | string): Promise<TMessage> {
     ...
     */
    async bulkDeleteMessages(channelId: string, messages: Array<string>): Promise<void> {
     ...
     */
    async deleteReactionSelf(channelId: string, messageId: string, emoji: string): Promise<void> {
     ...
     */
    async getReactions(channelId: string, messageId: string, emoji: string): Promise<TUser[]> {
     ...
     * | Permissions needed | condition |
     ...
     | MANAGE_ROLES       |    always |
     */
    async editChannelPermission(channelId: string, permissionId: string, data: TPermissionOverwrite):Promise<void> {
     ...
     * | Permissions needed | condition |
     ...
     | MANAGE_ROLES       |    always |
     */
    async deleteChannelPermission(channelId: string, permissionId: string):Promise<void> {
     ...
     *| Permissions needed | condition |
     ...
     | MANAGE_CHANNELS    |    always |
     */
    async getChannelInvites(channelId: string): Promise<TInvite[]> {
     ...
     */
    async createChannelInvite(channelId: string, data:{max_age?: number, max_uses?: number, temporary?: boolean, unique?: boolean} = {}): Promise<TInvite> {
     ...
     * @returns {Promise.<void>} Resolves the Promise on successful execution
     */
    async startChannelTyping(channelId: string): Promise<void> {
     ...
     * | Permissions needed | condition |
     ...
     | MANAGE_MESSAGES    |    always |
     */
    async addChannelPinnedMessage(channelId: string, messageId: string): Promise<void> {
     ...
     * | Permissions needed | condition |
     ...
     | MANAGE_MESSAGES    |    always |
     */
    async removeChannelPinnedMessage(channelId: string, messageId: string): Promise<void> {
     ...
     * | OAUTH2 Scopes |
     ...
     | gdm.join      |
     */
    async addDmChannelRecipient(channelId: string, userId: string, data: { access_token: string, nick? : string }): Promise<void> {
     ...
     * @returns {Promise.<void>} Resolves the Promise on successful execution
     */
    async removeDmChannelRecipient(channelId: string, userId: string): Promise<void> {
